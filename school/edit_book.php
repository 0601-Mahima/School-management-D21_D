...
<body>
            ...
            $id=$_POST['edit'];
            		...
            		$query= "SELECT * FROM `textbook` WHERE id='$id'";
				  	       ...
				  	       <h3>Textbook</h3>
				  	         <div class="tab-content">
										<div class="tab-pane active" id="horizontal-form">
											<form class="form-horizontal" action="edit_book_handler.php" method="post">
				              ...
				              <div class="panel-body">
				                          <div class="form-group">
													...
													<div class="form-group">
														<label for="focusedinput" class="col-sm-2 control-label">Issue_date:</label>
														<div class="col-sm-8">
