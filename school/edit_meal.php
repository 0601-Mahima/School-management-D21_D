...
<html>
<head>
<title>Mid-day Meal details</title>
...
<body>
            ...
            $id=$_POST['edit'];
            		...
            		$query= "SELECT * FROM `midday_meal` WHERE id='$id'";
								  	       ...
								  	       <h3>Mid day meal</h3>
								  	         <div class="tab-content">
														<div class="tab-pane active" id="horizontal-form">
															<form class="form-horizontal" action="edit_meal_handler.php" method="post">
								              ...
								              <div class="panel-body">
																<div class="form-group">
																	...
																	<div class="col-sm-8">
																		<input type="text" class="form-control1" name="amount" id="focusedinput" placeholder="amount">
																	</div><br>
																	<div class="panel-body">
