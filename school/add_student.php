  	       ...
  	       <h3> Student Form</h3>
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="add_student_handler.php" method="post">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control1" name="sname" id="focusedinput" placeholder="Student Name">
                </div><br><br><br>
                          ...
                          <div class="form-group">
        									...
        									<div class="col-sm-8">
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="date" class="form-control1" name="dob" id="focusedinput" placeholder="dd/mm/yyyy">
													</div><br>
												</div>
												<div class="form-group">
													<label for="focusedinput" class="col-sm-2 control-label">Year of Joining:</label>
													<div class="col-sm-8">
														<input type="date" class="form-control1" name="yoj" id="focusedinput" placeholder="dd/mm/yyyy">
													</div><br>
												</div>
                  </div>
									</div>
